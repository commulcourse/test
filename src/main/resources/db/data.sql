...
insert into board_tb(title, user_id, created_at) values('두번째글입니다', 3, now());
insert into board_tb(title, user_id, created_at) values('세번째글입니다', 1, now());
insert into board_tb(title, user_id, created_at) values('네번째글입니다', 2, now());
insert into board_tb(title, user_id, created_at) values('다섯번째글입니다', 1, now());
insert into board_tb(title, user_id, created_at) values('여섯번째글입니다', 3, now());
insert into board_tb(title, user_id, created_at) values('일곱번째글입니다', 1, now());
insert into board_tb(title, user_id, created_at) values('여덟번째글입니다', 2, now());
insert into board_tb(title, user_id, created_at) values('아홉번째글입니다', 1, now());
